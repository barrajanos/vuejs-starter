    ...
    <div class="columns is-centered has-text-centered">
      <div class="column">
        <div class="good" v-if="radioLive === 'yes' & radioRoma === 'yes' ">
                    ...
                    <b-button v-if="nowlanguage === 'sk'" type="is-primary" onclick="abcd" size="is-large" class="red button-radius mt-10">{{ $prismic.richTextAsPlain(fields.application_button_text) }}</b-button>
